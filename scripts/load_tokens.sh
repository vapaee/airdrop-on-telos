...
# ratio 10:1 - min 1000.0000 TLOS - cap 40000.0000 TLOS
...
# ratio 1:0 - min 1.0000 TLOS - base 1.0000 VPE
# (only accounts with more than 1 TLOS will receive just 1 VPE)
cleos push action vapaeetokens setsnapshot '["snapsnapsnap",1,"VPE",0,10000,0,10000]' -p vapaeetokens@active
